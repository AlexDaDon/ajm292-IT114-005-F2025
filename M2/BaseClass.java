...
public class BaseClass {
    ...
    public static void printHeader(String ucid, int problem) {
        ...
        switch (problem) {
            case 1 -> System.out.println("Objective: Print out only odd values in a single line separate by commas");
            case 2 -> System.out.println("Objective: Print out the total sum of the passed array");
